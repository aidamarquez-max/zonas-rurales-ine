...
# ── Para incorporar datos de paro ────────────────────────────────────────────
# El fichero de paro (PARO_MUNICIPIOS_ABRIL26.xlsx) se procesa por separado
# con el script scripts/build_paro.py, que actualiza el municipios_ine.json.
# Ver: scripts/build_paro.py
